...
<img src="https://render.githubusercontent.com/render/math?math=\large \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ f(x) = A \exp \big[ {-(x - u)^2} \over {2 \sigma^2} \big]." align="center">
...
<img src="https://render.githubusercontent.com/render/math?math=\large \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ f(x) = A \exp \big\{ - {1 \over 2} \big[ {{x - \mathrm{mpv}} \over \mathrm{width}} %2B {\exp\big( {{x - \mathrm{mpv}} \over \mathrm{width}} \big)} \big] \big\}." align="center">
