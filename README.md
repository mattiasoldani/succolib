...
<p align="center">    
    <img src="https://render.githubusercontent.com/render/math?math=\large f(x) = {13.6~\mathrm{MeV}} \over E z \big( x \over X_{0} \big)^{1 \over 2} \big[1 %2B 0.038 \mathrm{ln}\big( x \over X_{0} \big) \big].">
</p>
